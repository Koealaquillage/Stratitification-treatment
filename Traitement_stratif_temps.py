# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 19:11:04 2020
...
#
#for i in range(15) :
#   ax_U.plot(dic_stat['U_'+str(1+i)],label='Level '+str(1+i))

ax_U.plot(dic_stat['U_1'],label='Level 1')
ax_U.plot(dic_stat['U_10'],label='Level 10')
...
#for i in range(15) :
#   ax_V.plot(dic_stat['V_'+str(1+i)],label='Level '+str(1+i))

ax_V.plot(dic_stat['V_1'],label='Level 1')
ax_V.plot(dic_stat['V_10'],label='Level 10')
